Shader "Universal Render Pipeline/GlitchRail"
{
    Properties
    {
        ...
        _SecondaryGlitchColor("Secondary Glitch Color", Color) = (1, 0, 1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "GlitchRailInput.hlsl"
            #include "GlitchRailForwardPass.hlsl"
            ENDHLSL
        }
